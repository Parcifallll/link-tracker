...
//        when(linkUpdateService.checkUpdate(link)).thenReturn(true);
//
...
//        Link link = buildLink("https://github.com/user/repo");
//        when(linkRepository.findAllWithChatIds()).thenReturn(Map.of(1L, List.of(link)));
//        when(linkUpdateService.checkUpdate(link)).thenReturn(false);
//
//        linkScheduler.checkUpdates();
//
...
//                        1L, List.of(link1),
//                        2L, List.of(link2)));
//        when(linkUpdateService.checkUpdate(link1)).thenReturn(true);
//        when(linkUpdateService.checkUpdate(link2)).thenReturn(false);
//
//        linkScheduler.checkUpdates();
//
